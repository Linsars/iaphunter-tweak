...
void mfObjCTxProbeTapped(void) {
    ...
    id ti = objc_retainedObject(class_createInstance(TI, 0));
    ...
    id pi = nil;
    if (PI) pi = objc_retainedObject(class_createInstance(PI, 0));
    if (pi) {
    ...
    id tx = objc_retainedObject(class_createInstance(TT, 0));
